...
export const ensRentAddress = process.env.NEXT_PUBLIC_RENTAL_CONTRACT_ADDRESS as `0x${string}`;
export const mainnetEnsRentAddress = process.env.NEXT_PUBLIC_MAINNET_RENTAL_CONTRACT_ADDRESS as `0x${string}`;
...
export const baseRegistrarAddress = process.env.NEXT_PUBLIC_BASE_REGISTRAR_ADDRESS as `0x${string}`;

export const nameWrapperAddress = process.env.NEXT_PUBLIC_NAMEWRAPPER_ADDRESS as `0x${string}`;

export const mainnetNameWrapperAddress = process.env.NEXT_PUBLIC_MAINNET_NAMEWRAPPER_ADDRESS as `0x${string}`;

export function getNameWrapperAddress(chainId: number) {
  return chainId === mainnet.id ? mainnetNameWrapperAddress : nameWrapperAddress;
}

export const ensGraphQL = process.env.NEXT_PUBLIC_ENS_GRAPHQL_URL;
export const mainnetEnsGraphQL = process.env.NEXT_PUBLIC_MAINNET_ENS_GRAPHQL_URL;
...
export const mainnetEnsRentGraphQL = process.env.NEXT_PUBLIC_MAINNET_ENS_RENT_GRAPHQL_URL;
