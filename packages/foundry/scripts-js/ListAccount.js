...
async function main() {
  ...
  if (!isValidAddress) {
    ...
    console.log(
      "\n💡 If you haven't generated a deployer keystore account yet, please run `npm run account:generate`. Then update the `.env` file with `ETH_KEYSTORE_ACCOUNT=scaffold-eth-custom`"
    );
    return;
  }
